...
namespace Framepack.Worker.Tets.Worker;
...
public class BaseUseCaseTests
{
    ...
    [Fact]
    public void Notificar_DeveChamarHandleComMensagemNula()
    {
        // Arrange
    ...
    [Fact]
    public void Notificar_DeveChamarHandleComValidationResultVazio()
    {
        // Arrange
        var validationResult = new ValidationResult();
